...
local Library = {
	Themes = {
		...
		Aqua = {
			...
			Secondary = Color3.fromRGB(26, 51, 92),
			Tertiary = Color3.fromRGB(153, 51, 133),
...
function Library:change_theme(toTheme)
	...
	Library.DisplayName.Text = "Hello!, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>"
...
function Library:create(options)
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = "Hello!, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>",
			TextScaled = true,
