...
local Library = {
	Themes = {
		...
		-- Main / Secondary may be gradient tables: { Sequence = ColorSequence, Rotation = degrees }
		Gradient = {
			Main = {
				Rotation = 118,
				Sequence = ColorSequence.new({
					ColorSequenceKeypoint.new(0, Color3.fromRGB(22, 16, 52)),
					ColorSequenceKeypoint.new(0.5, Color3.fromRGB(58, 32, 108)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(14, 72, 96)),
				}),
			},
			Secondary = {
				Rotation = 52,
				Sequence = ColorSequence.new({
					ColorSequenceKeypoint.new(0, Color3.fromRGB(34, 30, 56)),
					ColorSequenceKeypoint.new(0.5, Color3.fromRGB(44, 38, 72)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(28, 48, 74)),
				}),
			},
...
function Library:create(options)
	...
	do
		...
		sec:label{Text = "Themes: gradient slots", Description = "Main and Secondary can be { Sequence = ColorSequence, Rotation = number } instead of Color3; see Gradient theme. change_theme swaps UIGradient vs solid backgrounds."}
		sec:label{Text = "New theme: Gradient", Description = "Preset in the theme grid with purple→violet→teal main fill and cool secondary wash; accent Tertiary stays solid for buttons."}
